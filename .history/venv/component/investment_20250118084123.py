...
# Prediction
risk_index = model.predict([customer_profile])[0]  # Assuming predict() returns a list or array
predicted_risk = y_train[risk_index]  # Map the predicted index to the corresponding risk value
return predicted_risk

# Prediction
#risk_index = round(model.predict([customer_profile]))
